...
func ListStockEntry(params map[string]string) common.Result {
	...
	return service.ListStockEntry(params["shopId"], params["entryNo"], params["skuId"], params["storageId"], params["orderNo"], params["supplierId"], params["startTime"], params["endTime"], page, size)
}
...
// @Accept	x-www-form-urlencoded
// @Produce json
// @Param	id formData int false "入库单记录号"
// @Param	shopId formData string false "商户账号"
// @Param	skuId formData string false "货品编码"
// @Param	entryNo formData string false "入库单号"
// @Success 200 {object} model.StockEntry	"{\"status\":1,<br>\"msg\":\"成功\",<br>\"data\":{},<br>\"page\":null}"
// @Router	/entry/get [post][get]
func GetStockEntry(params map[string]string) common.Result {
	id := 0
	if utils.Exists(params, "id") {
		id, _ = strconv.Atoi(params["id"])
	}
	return service.GetStockEntry(params["shopId"], params["entryNo"], params["skuId"], id)
}

// SaveStockEntry	godoc
...
// @Success 200 {object} model.StockEntry	"{\"status\":1,<br>\"msg\":\"成功\",<br>\"data\":{},<br>\"page\":null}"
// @Router	/entry/save [post][get]
func SaveStockEntry(params map[string]string) common.Result {
	if !utils.Exists(params, "shopId") {
		return *common.Error(-1, "未传入商户账号参数")
	}
	price := 0
	...
	return service.SaveStockEntry(params["shopId"], params["entryNo"], params["type"], params["skuId"], params["unit"], params["orderNo"], params["storageId"], params["supplierId"], params["operator"], params["remark"], number, price)
}
...
func UpdateStockEntry(params map[string]string) common.Result {
	number, price := 0, 0
	if !utils.Exists(params, "id") {
	...
	return service.UpdateStockEntry(id, params["skuId"], params["unit"], params["orderNo"], params["storageId"], params["supplierId"], params["operator"], params["remark"], number, price)
}
...
func DeleteStockEntry(params map[string]string) common.Result {
	if !utils.Exists(params, "id") {
